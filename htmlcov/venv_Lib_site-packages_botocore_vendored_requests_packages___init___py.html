...
<head>
    ...
    <title>Coverage for venv\Lib\site-packages\botocore\vendored\requests\packages\__init__.py: 100%</title>
...
<div id="header">
    <div class="content">
        <h1>Coverage for <b>venv\Lib\site-packages\botocore\vendored\requests\packages\__init__.py</b> :
...
<p id="t3" class="stm run hide_run"><span class="key">from</span> <span class="op">.</span> <span class="key">import</span> <span class="nam">urllib3</span><span class="strut">&nbsp;</span></p>
